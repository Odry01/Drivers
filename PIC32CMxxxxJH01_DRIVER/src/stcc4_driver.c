...
/* Application Data
  ...
  Remarks:
    This structure should be initialized by the STCC4_DRIVER_Initialize function.
...
/*******************************************************************************
  ...
  Remarks:
    See prototype in stcc4_driver.h.
 */
    ...
    switch ( stcc4_driverData.state )
    {
        ...
        case STCC4_DRIVER_STATE_INIT:
        {
            ...
            if (appInitialized)
            {
                ...
                stcc4_driverData.state = STCC4_DRIVER_STATE_SERVICE_TASKS;
            }
            break;
        }

        case STCC4_DRIVER_STATE_SERVICE_TASKS:
        {
