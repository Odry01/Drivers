...
typedef struct
{
    uint8_t OFFSET_MSB;
    uint8_t OFFSET_LSB;
    uint8_t HIGH_SET_MSB;
    uint8_t HIGH_SET_LSB;
    uint8_t HIGH_CLEAR_MSB;
    uint8_t HIGH_CLEAR_LSB;
    uint8_t LOW_SET_MSB;
    uint8_t LOW_SET_LSB;
    uint8_t LOW_CLEAR_MSB;
    uint8_t LOW_CLEAR_LSB;
    uint8_t STATUS_MSB;
    uint8_t STATUS_LSB;
...
void HDC302X_DRIVER_Set_High_Alert(uint8_t I2C_ADDRESS);

void HDC302X_DRIVER_Clear_High_Alert(uint8_t I2C_ADDRESS);

void HDC302X_DRIVER_Set_Low_Alert(uint8_t I2C_ADDRESS);

void HDC302X_DRIVER_Clear_Low_Alert(uint8_t I2C_ADDRESS);
...
void HDC302X_DRIVER_Get_Offset(uint8_t I2C_ADDRESS);

void HDC302X_DRIVER_Get_High_Alert_Set(uint8_t I2C_ADDRESS);

void HDC302X_DRIVER_Get_High_Alert_Set_Store_Values(void);

void HDC302X_DRIVER_Get_High_Alert_Clear(uint8_t I2C_ADDRESS);

void HDC302X_DRIVER_Get_High_Alert_Clear_Store_Values(void);

void HDC302X_DRIVER_Get_Low_Alert_Set(uint8_t I2C_ADDRESS);

void HDC302X_DRIVER_Get_Low_Alert_Set_Store_Values(void);

void HDC302X_DRIVER_Get_Low_Alert_Clear(uint8_t I2C_ADDRESS);

void HDC302X_DRIVER_Get_Low_Alert_Clear_Store_Values(void);
...
void HDC302X_DRIVER_Auto_Mode_Measurement_Readout_Store_Values(void);

void HDC302X_DRIVER_Auto_Mode_Minimum_Temperature_Write(uint8_t I2C_ADDRESS);

void HDC302X_DRIVER_Auto_Mode_Minimum_Temperature_Read(uint8_t I2C_ADDRESS);
...
void HDC302X_DRIVER_Auto_Mode_Maximum_Temperature_Read(uint8_t I2C_ADDRESS);

void HDC302X_DRIVER_Auto_Mode_Maximum_Temperature_Store_Value(void);

void HDC302X_DRIVER_Auto_Mode_Minimum_Humidity_Write(uint8_t I2C_ADDRESS);

void HDC302X_DRIVER_Auto_Mode_Minimum_Humidity_Read(uint8_t I2C_ADDRESS);
...
void HDC302X_DRIVER_Auto_Mode_Maximum_Humidity_Read(uint8_t I2C_ADDRESS);
...
void HDC302X_DRIVER_Get_Status(uint8_t I2C_ADDRESS);

void HDC302X_DRIVER_Get_Status_Store_Value(void);

void HDC302X_DRIVER_Get_NIST_54(uint8_t I2C_ADDRESS);

void HDC302X_DRIVER_Get_NIST_54_Store_Value(void);

void HDC302X_DRIVER_Get_NIST_32(uint8_t I2C_ADDRESS);

void HDC302X_DRIVER_Get_NIST_32_Store_Value(void);

void HDC302X_DRIVER_Get_NIST_10(uint8_t I2C_ADDRESS);

void HDC302X_DRIVER_Get_NIST_10_Store_Value(void);
