...
{
    can0DataTx.data.EXAMPLE_TRANSMIT_DATA_0 = EXAMPLE_TRANSMIT_DATA_0;
    can0DataTx.data.EXAMPLE_TRANSMIT_DATA_1 = EXAMPLE_TRANSMIT_DATA_1;
    can0DataTx.data.EXAMPLE_TRANSMIT_DATA_2 = EXAMPLE_TRANSMIT_DATA_2;
    can0DataTx.data.EXAMPLE_TRANSMIT_DATA_3 = EXAMPLE_TRANSMIT_DATA_3;
    can0DataTx.data.EXAMPLE_TRANSMIT_DATA_4 = EXAMPLE_TRANSMIT_DATA_4;
    can0DataTx.data.EXAMPLE_TRANSMIT_DATA_5 = EXAMPLE_TRANSMIT_DATA_5;
    can0DataTx.data.EXAMPLE_TRANSMIT_DATA_6 = EXAMPLE_TRANSMIT_DATA_6;
    can0DataTx.data.EXAMPLE_TRANSMIT_DATA_7 = EXAMPLE_TRANSMIT_DATA_7;
}
