...
HDC302X_SENSOR_DATA hdc302x_sensorData;

HDC302X_SENSOR_SETTINGS hdc302x_sensorSettings;
...
void HDC302X_DRIVER_Initialize(void)
{
    ...
    EIC_CallbackRegister(EIC_PIN_0, HDC302X_DRIVER_Alert, 0);
}
...
void HDC302X_DRIVER_Tasks(void)
{
    switch (hdc302x_driverData.state)
    {
        case HDC302X_DRIVER_STATE_INIT:
        {
            ...
            hdc302x_driverData.state = HDC302X_DRIVER_STATE_CHECK_I2C_HANDLER;
            break;
        }

        case HDC302X_DRIVER_STATE_CHECK_I2C_HANDLER:
        {
        ...
        case HDC302X_DRIVER_STATE_SET_CONFIGURATION:
        {
            hdc302x_sensorSettings.MODE_MSB = HDC302X_CMD_MODE_A2S_MSB;
            hdc302x_sensorSettings.MODE_LSB = HDC302X_CMD_MODE_A2S_LPM0;
            hdc302x_sensorSettings.OFFSET_MSB = 0x80;
            hdc302x_sensorSettings.OFFSET_LSB = 0x80;
            hdc302x_sensorSettings.SET_HIGH_ALERT_MSB = 0xCD;
            hdc302x_sensorSettings.SET_HIGH_ALERT_LSB = 0x6D;
            hdc302x_sensorSettings.CLEAR_HIGH_ALERT_MSB = 0xBF;
            hdc302x_sensorSettings.CLEAR_HIGH_ALERT_LSB = 0x5F;
            hdc302x_sensorSettings.SET_LOW_ALERT_MSB = 0x32;
            hdc302x_sensorSettings.SET_LOW_ALERT_LSB = 0x83;
            hdc302x_sensorSettings.CLEAR_LOW_ALERT_MSB = 0x40;
            hdc302x_sensorSettings.CLEAR_LOW_ALERT_LSB = 0x92;
            hdc302x_driverData.state = HDC302X_DRIVER_STATE_ENTER_AUTO_MEASUREMENT_MODE;
            break;
        }

        case HDC302X_DRIVER_STATE_ENTER_AUTO_MEASUREMENT_MODE:
        {
            HDC302X_DRIVER_Enter_Auto_Measurement_Mode(hdc302x_driverData.I2C_ADDRESS[0]);
            TIMER_DRIVER_Start_Bus_TMR();
            hdc302x_driverData.state = HDC302X_DRIVER_STATE_ENTER_AUTO_MEASUREMENT_MODE_WAIT_FOR_TRANSFER;
            break;
        }

        case HDC302X_DRIVER_STATE_ENTER_AUTO_MEASUREMENT_MODE_WAIT_FOR_TRANSFER:
        {
            if (DRV_I2C_TransferStatusGet(hdc302x_driverData.I2C_TRANSFER_HANDLE) == DRV_I2C_TRANSFER_EVENT_COMPLETE)
            {
                TIMER_DRIVER_Stop_Bus_TMR();
                hdc302x_driverData.state = HDC302X_DRIVER_STATE_IDLE;
            }
            if (DRV_I2C_TransferStatusGet(hdc302x_driverData.I2C_TRANSFER_HANDLE) == DRV_I2C_TRANSFER_EVENT_ERROR)
            {
                TIMER_DRIVER_Stop_Bus_TMR();
                hdc302x_driverData.state = HDC302X_DRIVER_STATE_ERROR;
            }
            else if (TIMER_DRIVER_Get_Bus_TMR_Status() == true)
            {
                ...
                TIMER_DRIVER_Stop_Bus_TMR();
                hdc302x_driverData.state = HDC302X_DRIVER_STATE_TIMER_EXPIRED;
            }
            break;
        }
        ...
        case HDC302X_DRIVER_STATE_IDLE:
        {
            ...
            {
                hdc302x_driverData.state = HDC302X_DRIVER_STATE_GET_AUTO_MEASURE_VALUES;
            }
            break;
        }

        case HDC302X_DRIVER_STATE_GET_AUTO_MEASURE_VALUES:
        {
            HDC302X_DRIVER_Get_Auto_Measure_Values(hdc302x_driverData.I2C_ADDRESS[0]);
            TIMER_DRIVER_Start_Bus_TMR();
            hdc302x_driverData.state = HDC302X_DRIVER_STATE_GET_AUTO_MEASURE_VALUES_WAIT_FOR_TRANSFER;
            break;
        }

        case HDC302X_DRIVER_STATE_GET_AUTO_MEASURE_VALUES_WAIT_FOR_TRANSFER:
        {
            if (DRV_I2C_TransferStatusGet(hdc302x_driverData.I2C_TRANSFER_HANDLE) == DRV_I2C_TRANSFER_EVENT_COMPLETE)
            {
                TIMER_DRIVER_Stop_Bus_TMR();
                hdc302x_driverData.state = HDC302X_DRIVER_STATE_STORE_MEASURE_VALUES;
            }
            if (DRV_I2C_TransferStatusGet(hdc302x_driverData.I2C_TRANSFER_HANDLE) == DRV_I2C_TRANSFER_EVENT_ERROR)
            {
                TIMER_DRIVER_Stop_Bus_TMR();
        ...
        case HDC302X_DRIVER_STATE_STORE_MEASURE_VALUES:
        {
            HDC302X_DRIVER_Store_Measurement_Values();
            hdc302x_driverData.state = HDC302X_DRIVER_STATE_CALCULATE_DATA;
            break;
        }

        case HDC302X_DRIVER_STATE_CALCULATE_DATA:
        {
            HDC302X_DRIVER_Calculation_Temperature(hdc302x_sensorData.T_VALUE);
            HDC302X_DRIVER_Calculation_Humidity(hdc302x_sensorData.H_VALUE);
            hdc302x_driverData.state = HDC302X_DRIVER_STATE_STORE_VALUES;
            break;
        }

        case HDC302X_DRIVER_STATE_STORE_VALUES:
        {
