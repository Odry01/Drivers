...
typedef enum
{
    ...
    STCC4_DRIVER_STATE_PERFORM_CONDITIONING,
    STCC4_DRIVER_STATE_PERFORM_CONDITIONING_WAIT_FOR_TRANSFER,
    STCC4_DRIVER_STATE_START_PERFORM_CONDITIONING_DELAY,
    STCC4_DRIVER_STATE_WAIT_FOR_PERFORM_CONDITIONING,
    STCC4_DRIVER_STATE_IDLE,
    STCC4_DRIVER_STATE_EXIT_SLEEP_MODE,
    STCC4_DRIVER_STATE_START_EXIT_SLEEP_MODE_DELAY,
    STCC4_DRIVER_STATE_WAIT_FOR_EXIT_SLEEP_MODE,
    STCC4_DRIVER_STATE_START_SINGLE_SHOT_MEASURE,
    STCC4_DRIVER_STATE_START_SINGLE_SHOT_MEASURE_WAIT_FOR_TRANSFER,
    STCC4_DRIVER_STATE_START_SINGLE_SHOT_MEASURE_DELAY,
    STCC4_DRIVER_STATE_WAIT_FOR_SINGLE_SHOT_MEASURE,
    ...
    STCC4_DRIVER_STATE_ENTER_SLEEP_MODE,
    STCC4_DRIVER_STATE_ENTER_SLEEP_MODE_WAIT_FOR_TRANSFER,
